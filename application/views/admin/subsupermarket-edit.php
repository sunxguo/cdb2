...
<body>
<div class="pd-20">
  <form action="?id=<?php echo $subsupermarket->id;?>" class="form form-horizontal" id="form-member-add">
    <input id="type" value="1" type="hidden">
    <input id="id" value="<?php echo $subsupermarket->id;?>" type="hidden">
    <div class="row cl">
      ...
      <div class="formControls col-5"> <span class="select-box">
        <select id="supermarket" onchange="setSupermarketLogo();" class="select" size="1" name="demo1" datatype="*" nullmsg="请选择所属总超市！">
          ...
          <option value="<?php echo $sm->id;?>" <?php echo $subsupermarket->no==$sm->no?'selected':'';?>><?php echo $sm->name;?></option>
          <?php endforeach;?>
        </select>
        </span> </div>
      <div class="col-4"> </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?php echo $subsupermarket->sno;?>" placeholder="" id="sno" name="sno" datatype="*2-16" nullmsg="超市编号不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        ...
        <input type="text" class="input-text" value="<?php echo $subsupermarket->sname;?>" placeholder="" id="sname" name="sname" datatype="*2-16" nullmsg="分店名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <img src="<?php echo $subsupermarket->logo;?>" id="thumbnail" style="max-width:90%;max-height:100px;">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?php echo $subsupermarket->province;?>" placeholder="" id="province"  datatype="*" nullmsg="‘省’不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?php echo $subsupermarket->city;?>" placeholder="" id="city"  datatype="*" nullmsg="‘市’不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?php echo $subsupermarket->area;?>" placeholder="" id="area"  datatype="*" nullmsg="‘区’不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?php echo $subsupermarket->detailedarea;?>" placeholder="" id="detailedarea"  datatype="*" nullmsg="‘详细地址’不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?php echo $subsupermarket->lng;?>" placeholder="" id="lng"  datatype="*" ignore="ignore">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?php echo $subsupermarket->lat;?>" placeholder="" id="lat"  datatype="*" ignore="ignore">
      </div>
      <div class="col-4"> </div>
    </div>
    <!-- <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5 skin-minimal">
        <div class="radio-box">
          <input type="radio" id="status-1" name="status" value="0" datatype="*" <?php echo $subsupermarket->status=='0'?'checked':'';?>>
          <label for="status-1">立即启用</label>
        </div>
        <div class="radio-box">
          <input type="radio" id="status-2" name="status" value="1" <?php echo $subsupermarket->status=='1'?'checked':'';?>>
